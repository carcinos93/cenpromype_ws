    ...
    <div class="p-grid p-jc-center">
        ...
        <div class="col no-gutter p-col-12">
            <div class="p-col-12">
                ...
                select-color = "{{ !isset($sector['PROPIEDADES']['bg-hover']) ? '#F8911A' : $sector['PROPIEDADES']['bg-hover']  }}"
                propiedades-sector='{{ json_encode($sector["PROPIEDADES"]) }}'
                ></productos>
            </div>
	 ...
	 //var filtros = [{"value":idSector,"col":"CODIGO_PAIS","op":"eq"}];		
           ...
           /// 
            ...
            items: [
                ...
                { label: "{{ $sector->SECTOR_ECONOMICO }}",url: '{{ Wordpress::url("productos", ["sector" => $sector->CODIGO_SECTOR ]) }}', cssClass: "color-azul", "id" : "bread-sector" }
            ]
        });
