...
class Documento extends BaseModel
{
    ...
    protected $fillable = ['CODIGO_SECTOR','NOMBRE_DOCUMENTO', 'DESCRIPCION_DOCUMENTO', 'CODIGO_PRODUCTO', 'CONTENIDO', 'IMAGEN','RUTA_DOCUMENTO', 'ESTATUS', 'ACCESO','FECHA_ADICION', 'USUARIO_ADICION'];
